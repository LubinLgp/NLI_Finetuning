...
\caption{Baseline vs Finetuné — prompt \textbf{CoT}. Le modèle sans affinage CoT est déjà élevé~; le finetuning apporte un gain modéré mais consistant.}
